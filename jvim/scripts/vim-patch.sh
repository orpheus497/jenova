...
usage() {
  echo "Port Vim patches to jvim"
  echo "https://github.com/orpheus497/jvim/blob/main/runtime/doc/dev_vimpatch.txt"
  echo
...
preprocess_patch() {
  local file="$1"
  local nvim="jvim -u NONE -n -i NONE --headless"
...
stage_patch() {
  ...
  See the wiki for more information:
    * https://github.com/orpheus497/jvim/blob/main/runtime/doc/dev_vimpatch.txt
...
show_vimpatches() {
  get_vim_sources update
  printf "Vim patches missing from jvim:\n"
...
Instructions:
  To port one of the above patches to jvim, execute this script with the patch revision as argument and follow the instructions, e.g.
