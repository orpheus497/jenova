-- Usage:
--    # verbose
--    jvim -l scripts/lintcommit.lua main --trace
--
--    # silent
--    jvim -l scripts/lintcommit.lua main
--
--    # self-test
--    jvim -l scripts/lintcommit.lua _test
...
Invalid commit message: "%s"
  ...
  if failed > 0 then
    p([[
See also:
    https://github.com/orpheus497/jvim/blob/master/CONTRIBUTING.md#commit-messages
