...
//    only then raise syntax error regarding missing comma in list in jvim
...
//    ignored in jvim it is an error.
...
//    error regarding undefined variable "a" (or about missing colon).  jvim
...
//    expression by jvim: e.g. ":echo (1)(1)" will yield runtime error after
