  ...
  options = {
   ...
   names is normally ignored]],
    ...
    },
    {
      ...
      defaults = {
        if_true = '',
        doc = [["$XDG_CONFIG_HOME/jvim,
                     $XDG_CONFIG_DIRS[1]/jvim,
                     $XDG_CONFIG_DIRS[2]/jvim,
                     …
                     $XDG_DATA_HOME/jvim[-data]/site,
                     $XDG_DATA_DIRS[1]/jvim/site,
                     $XDG_DATA_DIRS[2]/jvim/site,
                     …
                     $VIMRUNTIME,
                     …
                     $XDG_DATA_DIRS[2]/jvim/site/after,
                     $XDG_DATA_DIRS[1]/jvim/site/after,
                     $XDG_DATA_HOME/jvim[-data]/site/after,
                     …
                     $XDG_CONFIG_DIRS[2]/jvim/after,
                     $XDG_CONFIG_DIRS[1]/jvim/after,
                     $XDG_CONFIG_HOME/jvim/after"]],
        meta = '...',
      },
      deny_duplicates = true,
      desc = [=[
        ...
        4. jvim/site subdirectories for each directory in $XDG_DATA_DIRS.
           This is for plugins which were installed by system administrator,
           but are not part of the jvim distribution. XDG_DATA_DIRS defaults
           to /usr/local/share/:/usr/share/, so system administrators are
           expected to install site plugins to /usr/share/jvim/site.
        5. $VIMRUNTIME, for files distributed with jvim.
        						*after-directory*
