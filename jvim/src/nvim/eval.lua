...
M.funcs = {
  ...
  serverstart = {
    ...
    desc = [=[
      ...
      <  - If {address} is omitted the name is "jvim". >vim
      	echo serverstart()
      < >
      	=> /tmp/jvim.bram/oknANW/jvim.15430.5
      <
      Example bash command to list all jvim servers: >bash
      	ls ${XDG_RUNTIME_DIR:-${TMPDIR}jvim.${USER}}/*/jvim.*.0
  ...
  stdpath = {
    ...
    desc = [=[
      ...
      which you can configure via |$JVIM_APPNAME| or the `$XDG_…`
