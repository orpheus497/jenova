...
--- vim.net.request('https://raw.githubusercontent.com/orpheus497/jvim/main/README.md', {
---   outpath = 'README.md',
--- })
---
--- -- Process the response
--- vim.net.request(
---   'https://api.github.com/repos/orpheus497/jvim',
---   {},
---   function (err, res)
---     if err then return end
---     local stars = vim.json.decode(res.body).stargazers_count
---     vim.print(('jvim currently has %d stars'):format(stars))
---   end
--- )
---
--- -- Write to both file and current buffer, but cancel it
--- local job = vim.net.request('https://raw.githubusercontent.com/orpheus497/jvim/main/README.md', {
---   outpath = 'README.md',
---   outbuf = 0,
--- })
--- job:close()
