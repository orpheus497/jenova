...
---
--- @type string
vim.o.backupdir = ".,$XDG_STATE_HOME/jvim/backup//"
...
---
--- @type string
vim.o.directory = "$XDG_STATE_HOME/jvim/swap//"
...
---
--- @type string
vim.o.undodir = "$XDG_STATE_HOME/jvim/undo//"
...
---
--- @type string
vim.o.viewdir = "$XDG_STATE_HOME/jvim/view//"
