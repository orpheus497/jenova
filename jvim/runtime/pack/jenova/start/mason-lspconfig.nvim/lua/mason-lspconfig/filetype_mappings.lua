...
return {
  ...
  astro = { "astro", "biome", "emmet_language_server", "emmet_ls", "eslint", "htmx", "oxlint", "stylelint_lsp", "tailwindcss", "unocss" },
  ...
  css = { "ast_grep", "biome", "codebook", "css_variables", "cssls", "emmet_language_server", "emmet_ls", "oxfmt", "stylelint_lsp", "tailwindcss", "unocss" },
  ...
  hlsl = { "slangd" },
  hoon = { "hoon_ls" },
  html = { "angularls", "antlersls", "ast_grep", "biome", "codebook", "djls", "djlsp", "emmet_language_server", "emmet_ls", "harper_ls", "herb_ls", "html", "htmx", "ltex", "ltex_plus", "lwc_ls", "oxfmt", "stimulus_ls", "stylelint_lsp", "superhtml", "tailwindcss", "unocss", "vale_ls" },
  ...
  less = { "css_variables", "cssls", "emmet_language_server", "emmet_ls", "oxfmt", "stylelint_lsp", "tailwindcss", "unocss" },
  lhaskell = { "hls" },
  ...
  scss = { "css_variables", "cssls", "emmet_language_server", "emmet_ls", "oxfmt", "somesass_ls", "stylelint_lsp", "tailwindcss", "unocss" },
  sdc = { "tclsp" },
  sh = { "bashls", "harper_ls" },
  shaderslang = { "slangd" },
  ...
  vmasm = { "asm_lsp" },
  vsh = { "v_analyzer" },
  vue = { "biome", "emmet_language_server", "emmet_ls", "eslint", "htmx", "oxfmt", "oxlint", "stylelint_lsp", "tailwindcss", "unocss", "vue_ls" },
  ["vue-html"] = { "unocss" },
  vv = { "v_analyzer" },
