...
-- lives in lua/jenova/health.lua (not lua/plugins/) so the scanner does not scan it
-- as a plugin spec.
--
...
-- ##Step purpose: This file returns an empty plugin spec table. The scanner scans
-- lua/plugins/*.lua expecting plugin specs. The actual health module is at
