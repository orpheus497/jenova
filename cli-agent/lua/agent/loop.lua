...
function M.run(opts)
    ...
    table.insert(tool_mandate_lines, "2. Copy old_string CHARACTER-FOR-CHARACTER from the Read output. Include every space, newline, and indent. Never reconstruct or guess it.")
