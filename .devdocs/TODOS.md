...
>
> **A-17 is built too** — 11:55, `PROGRESS.md`, Step 12f-1 — and gone from this file with them.
> Its mechanism was **not** what this file said: `getTrash` enumerated `<workspaces>` as a list of
> workspaces and met `.trash` itself among them. The row described the symptom.
>
> **In flight and NOT built:** **A-48** (12e-2, markdown links) and **A-16/A-18** (12f-2, the trash
> restore and a window surface). Neither has a `PROGRESS.md` entry and neither should until it is
> green.
>
