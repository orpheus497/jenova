...
Sessions 001-017(part four), the oldest half of `SESSION_HANDOFF.md`, moved here 2026-09-03 09:10
under the `AGENTS.md` archival policy. **Order is preserved: reverse-chronological, newest of the
archived set first.** The live log is `SESSION_HANDOFF.md`; this file is history and is not read at
session start unless the history is what is being investigated.

**Sessions 001-005 are not here either** — they are in git history at `349a9b5b~1`, path
`.devdocs/ARCHIVE/devdocs/SESSION_HANDOFF_pre-006.md`, a directory the USER deleted (**D-CE**).
