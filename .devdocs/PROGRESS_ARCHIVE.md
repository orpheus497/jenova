...
Entries 60-117, oldest half of `PROGRESS.md`, moved here 2026-09-03 09:10 under the
`AGENTS.md` archival policy (~40-entry threshold). **Order is preserved: reverse-chronological,
newest of the archived set first.** The live ledger is `PROGRESS.md`; this file is history and is
not read at session start unless the history is what is being investigated.
