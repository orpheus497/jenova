...
describe("parseModelId", () => {
  ...
  it("handles real-world examples correctly", () => {
    expect(parseModelId("meta-jenova/Jenova-3.1-8B")).toStrictEqual({
      activatedParams: null,
      modelName: "Jenova-3.1",
      orgName: "meta-jenova",
      params: "8B",
      quantization: null,
      raw: "meta-jenova/Jenova-3.1-8B",
      tags: [],
    });
    ...
    expect(
      parseModelId("Qwen/Qwen3-Coder-30B-A3B-Instruct-1M-BF16"),
    ).toStrictEqual({
      activatedParams: "A3B",
  ...
  it("handles real-world examples with quantization in segments", () => {
    expect(
      parseModelId("meta-jenova/Jenova-4-Scout-17B-16E-Instruct-Q4_K_M"),
    ).toStrictEqual({
      activatedParams: null,
      modelName: "Jenova-4-Scout",
      orgName: "meta-jenova",
      params: "17B",
      quantization: "Q4_K_M",
      raw: "meta-jenova/Jenova-4-Scout-17B-16E-Instruct-Q4_K_M",
      tags: ["16E", "Instruct"],
    });
    ...
    expect(
      parseModelId("mistralai/Devstral-2-123B-Instruct-2512-Q4_K_M"),
    ).toStrictEqual({
      activatedParams: null,
    ...
    expect(
      parseModelId("mistralai/Devstral-Small-2-24B-Instruct-2512-Q8_0"),
    ).toStrictEqual({
      activatedParams: null,
