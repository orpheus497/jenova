 ...
 */
export function mockServerProps(props: Partial<ApiJenovaCppServerProps>): void {
	...
	(serverStore as unknown as { props: ApiJenovaCppServerProps }).props = {
		...
		...props
	} as ApiJenovaCppServerProps;

	// Set router mode role so activeModelId can be set
	(serverStore as unknown as { props: ApiJenovaCppServerProps }).props.role = 'ROUTER';
