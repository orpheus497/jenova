...
Welcome to the **jca Web UI** component library! This Storybook showcases the components used in the modern web interface for the JCA server.

## 🚀 About This Project

WebUI is a modern web interface for the JCA server, built with SvelteKit and ShadCN UI. Features include:
