...
async function main() {
  ...
  if (existsSync(immutableDir)) {
    ...
    if (jsFiles.length === 1) {
      ...
      console.error(
        "Error: Multiple JS bundles found in",
        immutableDir,
  ...
  if (cssBundle) {
    const cssRegex = new RegExp(
      `(["'])/_app/immutable/assets/${cssBundle.replaceAll(".", "\\.")}(["'])`,
      "g",
    );
