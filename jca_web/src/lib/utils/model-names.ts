 ...
 *
 * @example
 * normalizeModelName('models/jenova-3.1-8b') // Returns: 'jenova-3.1-8b' (multiple slashes -> filename)
 * normalizeModelName('C:\\Models\\gpt-4') // Returns: 'gpt-4' (multiple slashes -> filename)
 * normalizeModelName('meta-jenova/Jenova-3.1-8B') // Returns: 'meta-jenova/Jenova-3.1-8B' (Hugging Face format)
