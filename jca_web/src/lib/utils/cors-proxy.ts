...
/**
 * Wrap original headers for proxying through the CORS proxy. This avoids issues with duplicated jca-specific and target headers when using the CORS proxy.
