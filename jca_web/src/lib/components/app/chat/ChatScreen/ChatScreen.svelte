		...
		<div class="w-full max-w-[48rem] px-4">
			<div class="mb-10 text-center" in:fade={{ duration: 300 }}>
				<div class="flex justify-center mb-6">
                    <div class="flex w-16 h-16 rounded-2xl bg-gradient-to-br from-brand-purple-light to-brand-crimson items-center justify-center font-mono font-bold text-xl shadow-2xl text-white">
                      JCA
                    </div>
                </div>
				<h1 class="mb-2 text-2xl font-semibold tracking-tight md:text-4xl text-foreground">Jenova Cognitive Architecture</h1>
