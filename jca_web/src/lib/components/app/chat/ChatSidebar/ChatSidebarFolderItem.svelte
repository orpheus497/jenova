...
{#if isExpanded}
    <div class="pl-6 mt-1 space-y-3 relative">
        ...
        <!-- Notes in Workspace -->
        <div>
            <div class="flex items-center justify-between group/wsnote px-2 text-[10px] uppercase font-bold text-yellow-500/70 hover:text-yellow-500 mb-1">
                <span>Notes</span>
        ...
        <!-- Files in Workspace -->
        <div>
            <button onclick={onViewFiles} class="w-full flex items-center justify-between group/wsfile px-2 py-2 rounded-lg text-sm transition-all text-blue-500/70 hover:bg-sidebar-accent hover:text-blue-500">
