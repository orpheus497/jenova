 ...
 *
 * Handles direct communication with the jenova-server's `/v1/chat/completions` endpoint.
 ...
 *   - Handles HTTP requests/responses with the jenova-server
 ...
 *   - Returns typed `ApiJenovaCppServerProps` responses
 *
 ...
 * - CORS proxy routing via jenova-server for cross-origin MCP servers
