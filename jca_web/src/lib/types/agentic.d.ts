...
export type AgenticAssistantMessage = Extract<
  AgenticMessage,
  { role: MessageRole.ASSISTANT }
>;
export type AgenticToolCallList = NonNullable<
  AgenticAssistantMessage["tool_calls"]
>;

export type AgenticChatCompletionRequest = Omit<
  ApiChatCompletionRequest,
  "messages"
> & {
...
export interface AgenticFlowParams {
  ...
  messages: (
    ApiChatMessageData | (DatabaseMessage & { extra?: DatabaseMessageExtra[] })
  )[];
