...
sequenceDiagram
    ...
    participant API as 🌐 JCA Node

    Note over serverStore: State:<br/>props: ApiJenovaCppServerProps | null<br/>loading, error<br/>role: ServerRole | null (MODEL | ROUTER)<br/>fetchPromise (deduplication)
    ...
    API-->>PropsSvc: ApiJenovaCppServerProps
